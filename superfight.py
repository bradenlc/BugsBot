...
class Superfight(GameInstance):
    def __init__(self, gameChannel, client, gameMode):
        ...
        self.fullAttrDeck = ["10 Of Them", "10 Of Them", "10 Stories Tall", "10 Stories Tall", "10 Stories Tall", "100 Of Them", "100 Of Them", "100 Stories Tall",
                             ...
                             "Agoraphobic", "Allergic To All Animals", "Armed With A Bacon-Wrapped Baseball Bat", "Armed With A Barbed Wire Net",
                             ...
                             "Armed With A Trident", "Armed With An Infinite Sausage Lasso", "Armed With An Impenetrable Shield", "Armed With An Axe",
                             ...
                             "Can Fly But Only Two Feet Above The Ground", "Can Fly If Nobody Is Watching", "Can Hold Breath Forever", "Can Kill With A Kiss",
                             ...
                             "Can Summon An Army Of Internet Trolls", "Can Summon Anything From A Hardware Store", "Can Take The Form Of Anything They Touch",
                             ...
                             "Can Turn Into Any Vehicle", "Can Turn Invisible While Singing Snow Tunes", "Can Turn To Steel", "Can Walk Through Solid Objects",
                             ...
                             "Entire Body Is Very Sticky", "Everything They Touch Turns To Hummus", "Explodes If They Stop Moving",
                             "Figuratively \"On Fire\"... And Literally", "Floating Down On A Parachute", "Frost Breath ", "Handcuffed To Golf Cart",
                             "Hands Are Covered In Butter", "Hands Glued To Hips", "Has A 6-Foot Neck", "Has A Battleship", "Has A Beard Made Of Bees", "Has A Hostage",
                             "Has A Magical Unicorn Horn", "Has A Skunk On A Stick", "Has A Time Machine Phone Booth", "Has A Voodoo Doll Of Opponent",
                             "Has An Invisiblity Cloak", "Has An Invisible Jet", "Has Feet Instead Of Hands", "Has Hands Instead Of Feet",
                             "Has Jellyfish Instead Of Hands", "Has Majestic Flamming Antlers Growing On Head", "Has No Bones", "Has One Tiny Baby Arm",
                             ...
                             "In A Helicopter", "In A Hot Air Balloon", "In A Jet Fighter", "In A Space Suit", "In A Giant Hamster Ball", "Invisible",
                             ...
                             "Is A Piñata", "Is A Stuffed Toy", "Is A Super Genius", "Is A Tween", "Is Amish", "Is Drunk", "Is Elderly", "Is Having A Really Good Hair Day",
                             "Is Made Of Guacamole", "Is Rabid", "Is Radioactive", "Is Really Hangry", "Is Really Into Fonts", "Is Really Really Good-Looking",
                             "Is Really Really Stupid", "Just Drank Five Energy Drinks", "Killed By Water", "Knows Kung Fu", "Laser Eyes", "Lays Exploding Eggs",
                             ...
                             "Locked In An Antique Diver's Helmet", "Locked In A Shark Cage", "Long Metal Claws Pop Out Of Hands", "Made Of Lava", "Made Of Mirrors",
                             ...
                             "Can Fly... At The Speed Of Molasses", "Can Leap Over Tall Buildings In A Single Bound", "Can Only Be Killed By A Shot To The Head",
                             "Can Only Be Killed By A Stake Through The Heart", "Can Summon Infinite Trampolines", "Cannons Instead Of Hands",
        ...
        self.fullCharDeck = ["101 Dalmatians", "Abraham Lincoln", "Alien", "Angel", "Apache Warrior", "Assassin", "Barney", "Billionaire Playboy", 
                             ...
                             "Forrest Gump", "Frankenstein's Monster", "Freddy", "French Bulldog", "Gandhi", "Genghis Khan", "George W. Bush", "Giant Squid", "Giraffe",
                             ...
                             "The Devil", "The Doctor", "The Dude", "The Illuminati", "The Kardashians", "The Player To Your Left", "The Pope", "The Statue Of Liberty",
                             ...
                             "Iron Giant", "Kaiju", "Keanu Reeves", "King Kong", "King Arthur", "Literal Teen Wolf", "Loch Ness Monster", "Mothra", "Ocelot",
